...
apa_table$Statement <- c(
  "Enough money to go fishing",
  "Confident in my fishing skills",
  "People to go fishing with",
  "Difficult to find the time" ,
  "Escape from daily routine",
  "I belong in the outdoors",
  "Job prevents me from fishing",
  "Family duties prevent me",
  "Supported by fishing community"
)
...
ft <- ft %>%
  ...
  set_caption(caption = "Fishers’ and Non-Fishers’ Perceptions of Constraints within Fishing")

# Export to Word
save_as_docx("Table" = ft, path = "APA_table5-Constraints.docx")
