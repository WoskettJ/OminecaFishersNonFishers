...
apa_table$Statement <- c(
  "All racial backgrounds are well-represented",
  "Inspired to fish (hear about racialized backgrounds)",
  "Feel discriminated against (racial background)",
  "Witness racism",
  "Experience racism",
  "Hear derogatory language"
)
...
ft <- ft %>%
  ...
  set_caption(caption = "Fishers’ and Non-Fishers’ Perceptions of Race within Fishing")

# Export to Word
save_as_docx("Table" = ft, path = "APA_table8-Race.docx")